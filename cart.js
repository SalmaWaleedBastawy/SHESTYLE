...
function renderCart() {
    ...
    cartRowsEl.innerHTML = rows.map(function (r) {
        ...
        if (product.colors && product.colors[0]) {
            meta.push("Color: " + product.colors[0].name);
        }
        ...
        if (
            ...
            meta.push("Size: " + product.sizes[0]);
        }
...
function wireCartRows() {
    ...
    document
        .querySelectorAll("#cartRows .cart-row")
        .forEach(function (row) {

            var id = row.dataset.id;

            var minusBtn =
                row.querySelector(".cart-qty-minus");

            var plusBtn =
                row.querySelector(".cart-qty-plus");
